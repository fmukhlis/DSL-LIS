...
const CreateDepartment = ({ className }: ComponentPropsWithoutRef<'div'>) => {
    ...
    const { flash } = usePage<Record<string, { departmentAddMsg: string }>>().props
        ...
        <div className={`bg-white p-5 rounded-lg shadow-lg ${className}`}>
            <form onSubmit={submitForm}>
                <div className="flex flex-col gap-3">
                    ...
                    {flash.departmentAddMsg && <Alert formID={formID} message={flash.departmentAddMsg} type='success' />}
