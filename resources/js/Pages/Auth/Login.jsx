...
export default function LogIn({ canResetPassword, mongo }) {
    // Alert
    const [isShowAlert, setIsShowAlert] = useState(false)
    const alertTransition = useTransition(isShowAlert, {
        from: { y: -20, opacity: 0 },
        enter: { y: 0, opacity: 1 },
        leave: { y: -10, opacity: 0 }, 
        config: { duration: isShowAlert ? 350 : 150 }
    })
    const animatedTopAlert = alertTransition((style, item) => (
        item ?
            <animated.div style={style}>
                <TopAlert closeHandler={() => setIsShowAlert(false)}>
                    <div>Invalid <span className='font-extrabold'>username</span> or <span className='font-extrabold'>password</span>.</div>
    ...
    useEffect(() => {
        setIsShowAlert((errors.username || errors.password) ? true : false)
        reset('password')
    }, [errors])
    ...
    return (
        <GuestLayout>
            <Head title='Log In' />
            <div className='text-center text-[1.9rem] font-extrabold font-motiva text-teal-600 mb-7'>Log In</div>
            ...
            <form onSubmit={submit}>
                ...
                <TextInput
                    ...
                    className={`block w-full ${(errors.username || errors.password) && "border-red-500 text-red-500"}`}
                ...
                <TextInput
                    ...
                    className={`mt-3 block w-full ${(errors.username || errors.password) && "border-red-500"}`}
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    {canResetPassword && (
                        <Link
                            ...
                            className="underline text-sm text-gray-600 hover:text-gray-900 rounded-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500"
                        >
                            Forgot password?
                        </Link>
                    )}
