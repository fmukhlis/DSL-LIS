...
import { CategoryModelProps, DoctorModelProps, PatientModelProps, RegisteredDoctorProps, RegisteredPatientProps, TestModelProps } from '@/Types'
...
const EditOrderModal = ({ can, categories, defaultData, externalDoctors, processedRegID, triggerElement }: {
  can: {
  ...
  const {
    ...
    setIsOpen,
    submitForm,
  } = useEditOrderModal({ can, defaultData, externalDoctors, processedRegID })
