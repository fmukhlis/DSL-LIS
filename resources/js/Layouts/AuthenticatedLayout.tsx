            ...
            <NavigationMenu>
                <NavigationMenuList>
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuLink asChild>
                            <ResponsiveNavLink
                                active={url.startsWith('/order-test') ? true : false}
                                href={url === '/order-test' ? `#` : route('order.test')}
                            >
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuLink asChild>
                            <ResponsiveNavLink
                                active={url.startsWith('/input-result') ? true : false}
                                href={url === '/input-result' ? `#` : route('input.result')}
                            >
                                <DiscordLogoIcon width={18} height={18} />
                            </ResponsiveNavLink>
                        </NavigationMenuLink>
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuLink asChild>
                            <ResponsiveNavLink
                                active={url.startsWith('/test-result') ? true : false}
                                href={url === '/test-result' ? `#` : route('testresult')}
                            >
                                <DiscordLogoIcon width={18} height={18} />
                            </ResponsiveNavLink>
                        </NavigationMenuLink>
                    ...
                    <NavigationMenuItem className='ml-auto'>
                        <NavigationMenuLink asChild>
                            <NavDropdownMenu
                                minWidth='500px'
                                trigger={{ title: <BellIcon width={24} height={24} />, withIcon: false }}
                            >
                                <DropdownMenuItem
                                    className={`
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuLink asChild>
                            <NavDropdownMenu
                                minWidth='350px'
                                trigger={{ title: <>Anaylst</>, withIcon: true }}
                            >
                                <DropdownMenuLabel
                                    className={`
                                ...
                                <DropdownMenuItem>
                                    <NavigationMenuLink asChild>
                                        <Link
                                            ...
                                            href={route('logout')}
                                            className={`
                                                flex justify-center items-center py-1.5 px-2 outline-none rounded-sm duration-100 select-none font-bold w-full
